...
import { Text, View, ScrollView, RefreshControl, Modal, TextInput, Button, TouchableOpacity } from 'react-native'
...
const Statistical = () => (
  <View style={finance.screen}>
    <Text style={finance.content}>Profit: $6,000</Text>
  </View>
)
